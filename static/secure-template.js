...
//can only be viewed once a user has logged in same general layout as other template but authencticated
	...
	class SecureTemplate extends React.Component {
		static async getInitialProps({ req }) {
			...
			const pageProperties =
				...
				(await Page.getInitialProps(req));
			return {
				...pageProperties,
				loggedInUser,
